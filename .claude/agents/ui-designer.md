...
Query context manager for brand guidelines and design requirements
Review existing design patterns and component libraries
Analyze user needs and business objectives
Begin design implementation following established principles
Design checklist:
